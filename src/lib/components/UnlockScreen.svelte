  ...
  >
    <div class="glass-modal">
      <div style="text-align: center; margin-bottom: 1.5rem;">
        <div
          style="font-size: 3.75rem; margin-bottom: 1rem;"
          class="animate-bounce-subtle"
        >
          {#if biometricType === "FaceID"}
            <span
              style="display: flex; align-items: center; justify-content: center;"
              ><ScanFace size={60} strokeWidth={1} color="currentColor" /></span
            >
        ...
        <h1
          style="font-size: 1.5rem; font-weight: 600; margin: 0 0 0.5rem 0;"
          class="text-glass"
        >
          Set up {biometricType}
        </h1>
        <p class="text-glass-secondary">
          Enable {biometricType} for quick and secure access
        </p>
      </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 1rem;">
        {#if error}
          <div
            ...
            style="background: rgba(255,107,107,0.2); border: 1px solid rgba(255,107,107,0.3); color: #ff6b6b; padding: 0.75rem; border-radius: 12px; font-size: 0.875rem; text-align: center;"
          >
            {error}
          </div>
        {/if}
  ...
  >
    <div class="glass-modal">
      <div style="text-align: center; margin-bottom: 2rem;">
        <div
          style="font-size: 3.75rem; margin-bottom: 1rem; display: flex; justify-content: center;"
          class="animate-bounce-subtle flex justify-center w-full"
        >
      ...
      <div style="display: flex; flex-direction: column; gap: 1rem;">
        {#if BiometricAuth.isEnabled() && hasExistingVault}
          ...
          <div style="position: relative;">
            ...
            <div
              style="position: relative; display: flex; justify-content: center; font-size: 0.875rem;"
            >
              <span
                class="glass text-glass-secondary"
                style="padding: 0 1rem; font-size: 0.75rem;">or</span
              >
            </div>
          </div>
        {/if}
        ...
        {#if !hasExistingVault}
          <div class="glass" style="padding: 1rem; text-align: center;">
            <p
              style="font-size: 0.75rem; margin: 0; line-height: 1.6;"
              class="text-glass-secondary"
            >
              Choose a strong master password. This cannot be recovered if
              forgotten.
            </p>
          </div>
        {/if}
